...
export interface ApiCiudadCiudad extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    excursion: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AllDay: Schema.Attribute.Boolean;
    Calendar: Schema.Attribute.Enumeration<
      ['Personal', 'Business', 'Family', 'Holiday', 'Other']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiExcursionExcursion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Accesibilidad: Schema.Attribute.Boolean;
...
export interface ApiPropiedadPropiedad extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    WiFiNetwork: Schema.Attribute.String;
    WiFiPassword: Schema.Attribute.String;
  };
}
