import { _ as _export_sfc$1, a as _sfc_main$s } from './server.mjs';
...
const _sfc_main = defineComponent({
  name: "Calendar",
  components: { VueCal: index, NCheckbox, Icon: _sfc_main$s },
  data: () => ({
    demoExample,
    split: false,
    monthEvents: false,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Icon = _sfc_main$s;
...
//# sourceMappingURL=VueCal-D8pTEY96.mjs.map
