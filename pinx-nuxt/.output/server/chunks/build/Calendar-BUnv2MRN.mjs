...
import { aV as useMessage, _ as _sfc_main$o, U as resolveSlotWithTypedProps, B as Button, i as NBaseIcon, ae as ChevronRightIcon, v as useConfig, x as useTheme, bF as calendarLight, m as c$1, X as useLocale, z as useThemeClass, k as cB, ak as insideModal, al as insidePopover, n as cE, l as cM, C as call } from './server.mjs';
import { useMergedState } from 'vooks';
import { k as getYear, j as getMonth, b as startOfMonth, d as dateArray, a as addMonths } from './utils-Dsl_XouJ.mjs';
import { e as startOfDay, f as format } from './getDefaultOptions-B-S4FfjT.mjs';
import { N as NButtonGroup } from './ButtonGroup-B1rpYDNl.mjs';
import { C as ChevronLeftIcon } from './CollapseItem-S6SsK5xW.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))}><div class="page-header"><div class="title">Calendario</div><div class="links"><a href="https://www.naiveui.com/en-US/light/components/calendar" target="_blank" alt="docs" rel="nofollow noopener noreferrer">`);
...
//# sourceMappingURL=Calendar-BUnv2MRN.mjs.map
