...
import { N as NRow, a as NCol } from './Col-tTrzmjPH.mjs';
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(NStatistic), {
                          ...
                          prefix: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_sfc_main$o, { name: Save }, null, _parent5, _scopeId4));
                            } else {
                              return [
                                createVNode(_sfc_main$o, { name: Save })
                              ];
                            }
                          }),
...
//# sourceMappingURL=Statistic-CwmHxys1.mjs.map
