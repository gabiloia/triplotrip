...
import { _ as _sfc_main$s, aW as NText } from './server.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(NCollapse), null, {
              "header-extra": withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$s, { name: CashIcon }, null, _parent3, _scopeId2));
                } else {
                  return [
...
//# sourceMappingURL=Collapse-ERxGSrXY.mjs.map
