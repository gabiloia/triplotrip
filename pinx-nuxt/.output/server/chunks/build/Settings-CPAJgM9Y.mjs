import { defineComponent, useModel, computed, mergeProps, unref, withCtx, createBlock, openBlock, createVNode, ref, createTextVNode, h, watch, withKeys, renderSlot, resolveComponent, createCommentVNode, useSSRContext } from 'vue';
...
import { a as _export_sfc, aa as useThemeStore, B as Button, _ as _sfc_main$o, aD as Logo, G as NFadeInExpandTransition, v as useConfig, x as useTheme, aA as collapseTransitionLight, k as cB, X as useRtl, z as useThemeClass, aB as useMessage, az as useAuthStore, aC as NDivider, E as fadeInHeightExpandTransition } from './server.mjs';
import { useRouter } from 'vue-router';
import { N as NForm, a as NFormItem } from './FormItem-GCUOpT98.mjs';
...
const _imports_1 = "data:image/svg+xml,%3csvg%20width='29'%20height='29'%20viewBox='0%200%2029%2029'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20id='Facebook%20'%20clip-path='url(%23clip0_128_129)'%3e%3cpath%20id='Vector'%20d='M28.5%2014.4751C28.5%206.7431%2022.232%200.475098%2014.5%200.475098C6.76801%200.475098%200.5%206.7431%200.5%2014.4751C0.5%2021.4628%205.61957%2027.2547%2012.3125%2028.305V18.522H8.75781V14.4751H12.3125V11.3907C12.3125%207.88197%2014.4027%205.94385%2017.6005%205.94385C19.1318%205.94385%2020.7344%206.21728%2020.7344%206.21728V9.6626H18.9691C17.23%209.6626%2016.6875%2010.7419%2016.6875%2011.8501V14.4751H20.5703L19.9496%2018.522H16.6875V28.305C23.3804%2027.2547%2028.5%2021.4628%2028.5%2014.4751Z'%20fill='%231877F2'/%3e%3cpath%20id='Vector_2'%20d='M19.9496%2018.522L20.5703%2014.4751H16.6875V11.8501C16.6875%2010.7429%2017.23%209.6626%2018.9691%209.6626H20.7344V6.21729C20.7344%206.21729%2019.1323%205.94385%2017.6005%205.94385C14.4027%205.94385%2012.3125%207.88197%2012.3125%2011.3907V14.4751H8.75781V18.522H12.3125V28.305C13.762%2028.5318%2015.238%2028.5318%2016.6875%2028.305V18.522H19.9496Z'%20fill='white'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_128_129'%3e%3crect%20width='28'%20height='28'%20fill='white'%20transform='translate(0.5%200.475098)'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Button), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="px-2"${_scopeId}>Sign in with Google</span>`);
          } else {
            return [
              createVNode("span", { class: "px-2" }, "Sign in with Google")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(unref(Button), {
        ...
        icon: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img alt="facebook-icon" class="block h-5"${ssrRenderAttr("src", _imports_1)}${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                alt: "facebook-icon",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="px-2"${_scopeId}>Sign in with Facebook</span>`);
          } else {
            return [
              createVNode("span", { class: "px-2" }, "Sign in with Facebook")
            ];
          }
        }),
        _: 1
  ...
  setup(__props) {
    ...
    async function register() {
      ...
      (_a = formRef.value) == null ? void 0 : _a.validate(async (errors) => {
        ...
        if (!errors) {
          try {
            const res = await $fetch("https://admin.triplotrip.com/api/auth/local/register", {
              method: "POST",
              body: {
                username: model.value.email,
                // Strapi requiere `username`
          ...
          message.error("Por favor, complet\xE1 todos los campos correctamente.");
        }
      });
    }
    watch(isValid, (val) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_n_form_item, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_n_input, {
                    value: model.value.email,
                    "onUpdate:value": ($event) => model.value.email = $event,
                    size: "large",
                ...
                if (_push3) {
                  ...
                  return [
                    createVNode("div", { class: "flex w-full flex-col gap-3" }, [
                      ...
                      model.value.password ? (openBlock(), createBlock(_sfc_main$3, {
                        key: 0,
                        password: model.value.password,
                        onStrength: ($event) => passwordStrength.value = $event
            ...
            _push2(ssrRenderComponent(_component_n_button, {
              type: "primary",
              class: "w-full!",
              size: "large",
              disabled: !isValid.value,
      ...
      _push(ssrRenderComponent(_component_n_divider, { "title-placement": "center" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Or`);
          } else {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (type.value === "signin") {
        _push(ssrRenderComponent(_sfc_main$4, { key: "signin" }, {
        ...
        _push(ssrRenderComponent(_sfc_main$2, { key: "signup" }, {
          "bottom-area": withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(ssrRenderComponent(_sfc_main$5, { key: "forgotpassword" }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</template></div>`);
...
const AuthForm = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-026a392c"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    "alignModifiers": {},
    "activeColor": { default: "" },
    "activeColorModifiers": {}
  },
  emits: ["update:align", "update:activeColor"],
  setup(__props) {
    const align = useModel(__props, "align");
    const activeColor = useModel(__props, "activeColor");
    const themeStore = useThemeStore();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "settings flex items-center justify-between" }, _attrs))} data-v-f942ee17><div class="layout" data-v-f942ee17>`);
      _push(ssrRenderComponent(unref(Button), {
        quaternary: "",
        circle: "",
        onClick: ($event) => align.value = "center"
      }, {
        icon: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (align.value === "center") {
                    _push3(ssrRenderComponent(unref(Icon), { icon: AlignCenterActive }, null, _parent3, _scopeId2));
                  } else {
                    _push3(ssrRenderComponent(unref(Icon), { icon: AlignCenter }, null, _parent3, _scopeId2));
                  }
                } else {
                  return [
                    align.value === "center" ? (openBlock(), createBlock(unref(Icon), {
                      key: 0,
      ...
      _push(`</div><div class="colors" data-v-f942ee17><!--[-->`);
      ssrRenderList(colors.value, (color) => {
        _push(ssrRenderComponent(unref(Button), {
          key: color,
          quaternary: "",
          circle: "",
          onClick: ($event) => activeColor.value = color
        }, {
          icon: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_sfc_main$o, { color }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (activeColor.value === color) {
                      _push3(ssrRenderComponent(unref(Icon), { icon: SquareActive }, null, _parent3, _scopeId2));
                    } else {
                      _push3(ssrRenderComponent(unref(Icon), { icon: Square }, null, _parent3, _scopeId2));
                    }
                  } else {
                    return [
                      activeColor.value === color ? (openBlock(), createBlock(unref(Icon), {
                        key: 0,
                        icon: SquareActive
                      })) : (openBlock(), createBlock(unref(Icon), {
                        key: 1,
      ...
      _push(ssrRenderComponent(unref(Button), {
        quaternary: "",
        circle: "",
        onClick: ($event) => activeColor.value = primaryColor.value
      }, {
        icon: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$o, { color: primaryColor.value }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (activeColor.value === primaryColor.value) {
                    _push3(ssrRenderComponent(unref(Icon), { icon: SquareActive }, null, _parent3, _scopeId2));
                  } else {
                    _push3(ssrRenderComponent(unref(Icon), { icon: Square }, null, _parent3, _scopeId2));
                  }
                  ...
                  return [
                    activeColor.value === primaryColor.value ? (openBlock(), createBlock(unref(Icon), {
                      key: 0,
                      icon: SquareActive
                    })) : (openBlock(), createBlock(unref(Icon), {
                      key: 1,
            ...
            return [
              createVNode(_sfc_main$o, { color: primaryColor.value }, {
                default: withCtx(() => [
                  activeColor.value === primaryColor.value ? (openBlock(), createBlock(unref(Icon), {
                    key: 0,
                    icon: SquareActive
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/auth/Settings.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Settings = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f942ee17"]]);

export { AuthForm as A, Settings as S };
//# sourceMappingURL=Settings-CPAJgM9Y.mjs.map
