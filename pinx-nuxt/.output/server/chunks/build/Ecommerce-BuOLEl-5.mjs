...
import { mergeProps, defineComponent, ref, unref, withCtx, createTextVNode, createVNode, toDisplayString, createBlock, createCommentVNode, openBlock, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr } from 'vue/server-renderer';
import { a as _export_sfc, N as NCard, B as Button, _ as _sfc_main$s, c as NAvatar } from './server.mjs';
import { faker } from '@faker-js/faker';
import { N as NRate } from './Rate-sdFmzZuv.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(NCard), mergeProps({ hoverable: "" }, _attrs), {
        cover: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (imagenUrl.value) {
              _push2(`<img${ssrRenderAttr("src", imagenUrl.value)} alt="Foto principal" width="900" height="400"${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              imagenUrl.value ? (openBlock(), createBlock("img", {
                key: 0,
                src: imagenUrl.value,
                alt: "Foto principal",
                width: "900",
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<span${_scopeId}>${ssrInterpolate(((_a = propiedad.value) == null ? void 0 : _a.Titulo) || "Cargando t\xEDtulo...")}</span><span class="text-secondary ml-3"${_scopeId}>$644,00</span>`);
          } else {
            return [
              createVNode("span", null, toDisplayString(((_b = propiedad.value) == null ? void 0 : _b.Titulo) || "Cargando t\xEDtulo..."), 1),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<p${_scopeId}>${ssrInterpolate(((_a = propiedad.value) == null ? void 0 : _a.Descripcion) || "Cargando descripcion...")}</p>`);
          } else {
            return [
              createVNode("p", null, toDisplayString(((_b = propiedad.value) == null ? void 0 : _b.Descripcion) || "Cargando descripcion..."), 1)
            ];
          }
        }),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Button), { type: "primary" }, {
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$s, { name: CartIcon }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_sfc_main$s, { name: CartIcon })
                  ];
                }
              }),
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Button), { type: "primary" }, {
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$s, { name: PremiumIcon }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_sfc_main$s, { name: PremiumIcon })
                  ];
                }
              }),
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
...
//# sourceMappingURL=Ecommerce-BuOLEl-5.mjs.map
