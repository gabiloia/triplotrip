...
import { a as _export_sfc, aE as NTag, B as Button, _ as _sfc_main$o } from './server.mjs';
import { faker } from '@faker-js/faker';
import _orderBy from 'lodash/orderBy.js';
import { N as NTable } from './Table-ZwyKUzIw.mjs';
import dayjs from 'dayjs';
import { a as NImage } from './Image-CiL9m40l.mjs';
import { N as NProgress } from './Progress-CTmj2S_J.mjs';
import { N as NPopselect } from './Popselect-DeYg37eR.mjs';
              ...
              if (_ctx.showActions) {
                ...
                _push2(ssrRenderComponent(unref(Button), { secondary: "" }, {
                  icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(_sfc_main$o, { name: DeleteIcon }, null, _parent3, _scopeId2));
                    } else {
                      return [
                        createVNode(_sfc_main$o, { name: DeleteIcon })
                      ];
                    }
                  }),
                  _: 2
                ...
                _push2(ssrRenderComponent(unref(Button), { secondary: "" }, {
                  icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(_sfc_main$o, { name: DownloadIcon }, null, _parent3, _scopeId2));
                    } else {
                      return [
                        createVNode(_sfc_main$o, { name: DownloadIcon })
                      ];
                    }
                  }),
                  _: 2
                    ...
                    if (_push3) {
                      _push3(ssrRenderComponent(unref(Button), { secondary: "" }, {
                        icon: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(_sfc_main$o, { name: MenuIcon }, null, _parent4, _scopeId3));
                          } else {
                            return [
                              createVNode(_sfc_main$o, { name: MenuIcon })
                            ];
                          }
                        }),
                        _: 2
...
//# sourceMappingURL=Base-C1YldzQp.mjs.map
