...
const ProfileSettings = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-8cf4d11c"]]);
  ...
  setup(__props) {
    ...
    async function submitForm() {
      try {
        ...
        if (!form.value.FotoPrincipal) throw new Error("Debe subir una imagen");
        ...
        if (!uploadResponse.ok) {
          throw new Error(`Error subiendo imagen: ${uploadResponse.statusText}`);
        }
        const uploaded = await uploadResponse.json();
        const uploadedFile = Array.isArray(uploaded) ? uploaded[0] : uploaded;
        await $fetch("https://admin.triplotrip.com/api/propiedades", {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          body: JSON.stringify({
            ...
            FotoPrincipal: uploadedFile.id,
            owner: { connect: [currentUser.value.id] }
          })
        });
        notification.success({ title: "Propiedad creada", content: "Se cre\xF3 correctamente." });
        showModal.value = false;
        form.value = { Titulo: "", Descripcion: "", FotoPrincipal: null };
        await fetchPropiedades();
      } catch (err) {
        console.error(err);
        notification.error({ title: "Error", content: err.message || "No se pudo crear" });
      }
    }
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "activity" }, _attrs))} data-v-ea472855><div class="mb-4 flex justify-end" data-v-ea472855>`);
      ...
      _push(`</div><div class="masonry" data-v-ea472855><!--[-->`);
      ssrRenderList(propiedades.value, (prop, index) => {
        _push(`<div class="card-wrap" data-v-ea472855>`);
        _push(ssrRenderComponent(unref(NCard), {
          ...
          cover: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("alt", prop.Titulo || "Imagen")}${ssrRenderAttr("src", getImageUrl(prop.FotoPrincipal))} width="900" height="400" data-v-ea472855${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
          ...
          header: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span data-v-ea472855${_scopeId}>${ssrInterpolate(prop.Titulo)}</span>`);
            } else {
              return [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<p data-v-ea472855${_scopeId}>${ssrInterpolate(prop.Descripcion)}</p>`);
            } else {
              return [
...
const ProfileActivity = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ea472855"]]);
...
//# sourceMappingURL=Profile-zi8lMvYf.mjs.map
