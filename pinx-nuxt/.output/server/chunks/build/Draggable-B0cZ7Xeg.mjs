...
import { a as _export_sfc, a_ as useMessage, B as Button } from './server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_CardCodeExample, mergeProps({ title: "Column draggable" }, _attrs), {
    description: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Only support leaf nodews`);
      } else {
        return [
          createTextVNode("Only support leaf nodews")
        ];
      }
    }),
...
//# sourceMappingURL=Draggable-B0cZ7Xeg.mjs.map
