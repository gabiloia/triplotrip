...
import { _ as _sfc_main$s, bw as NBadge, c as NAvatar, B as Button, aW as NText } from './server.mjs';
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(Button), {
                          ...
                          icon: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_sfc_main$s, { name: Add }, null, _parent5, _scopeId4));
                            } else {
                              return [
                                createVNode(_sfc_main$s, { name: Add })
                              ];
                            }
                          }),
                          _: 1
                        ...
                        _push4(ssrRenderComponent(unref(Button), {
                          ...
                          icon: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_sfc_main$s, { name: Remove }, null, _parent5, _scopeId4));
                            } else {
                              return [
                                createVNode(_sfc_main$s, { name: Remove })
                              ];
                            }
                          }),
                          _: 1
...
//# sourceMappingURL=Badge-Bz2be8jN.mjs.map
