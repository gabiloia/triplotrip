...
import { _ as _export_sfc, ab as useThemeStore, B as Button, a as _sfc_main$s, b0 as Logo, E as NFadeInExpandTransition, u as useConfig, s as useTheme, aZ as collapseTransitionLight, j as cB, U as useRtl, x as useThemeClass, a_ as useMessage, aY as useAuthStore, a$ as NDivider, C as fadeInHeightExpandTransition } from './server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full max-w-96 min-w-64" }, _attrs))} data-v-22b55920>`);
      ...
      _push(`<div class="my-10" data-v-22b55920>`);
      ...
      _push(`<div class="font-display mb-4 text-4xl font-bold" data-v-22b55920>${ssrInterpolate(title.value)}</div><div class="text-secondary mb-12 text-lg" data-v-22b55920> Today is a new day. It&#39;s your day. You shape it. Sign in to start managing your projects. </div></div><template>`);
      if (type.value === "signin") {
        _push(ssrRenderComponent(_sfc_main$4, { key: "signin" }, {
          ...
          "bottom-area": withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="text-center" data-v-22b55920${_scopeId}> Don&#39;t you have an account? `);
              _push2(ssrRenderComponent(unref(Button), {
                text: "",
                type: "primary",
                size: "large",
              ...
              return [
                createVNode("div", { class: "text-center" }, [
                  createTextVNode(" Don't you have an account? "),
                  createVNode(unref(Button), {
                    text: "",
                    type: "primary",
                    size: "large",
        ...
        _push(ssrRenderComponent(_sfc_main$2, { key: "signup" }, {
          "bottom-area": withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="text-center" data-v-22b55920${_scopeId}> Do you have an account? `);
              _push2(ssrRenderComponent(unref(Button), {
                text: "",
                type: "primary",
                size: "large",
              ...
              return [
                createVNode("div", { class: "text-center" }, [
                  createTextVNode(" Do you have an account? "),
                  createVNode(unref(Button), {
                    text: "",
                    type: "primary",
                    size: "large",
...
const AuthForm = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-22b55920"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "settings flex items-center justify-between" }, _attrs))} data-v-19d6ac4e><div class="layout" data-v-19d6ac4e>`);
      _push(ssrRenderComponent(unref(Button), {
        quaternary: "",
        circle: "",
        onClick: ($event) => align.value = "left"
      }, {
        icon: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$s, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (align.value === "left") {
                    _push3(ssrRenderComponent(unref(Icon), { icon: AlignLeftActive }, null, _parent3, _scopeId2));
                  } else {
                    _push3(ssrRenderComponent(unref(Icon), { icon: AlignLeft }, null, _parent3, _scopeId2));
                  }
                } else {
                  return [
                    align.value === "left" ? (openBlock(), createBlock(unref(Icon), {
                      key: 0,
      ...
      _push(ssrRenderComponent(unref(Button), {
        quaternary: "",
        circle: "",
        onClick: ($event) => align.value = "right"
      }, {
        icon: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$s, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (align.value === "right") {
                    _push3(ssrRenderComponent(unref(Icon), { icon: AlignRightActive }, null, _parent3, _scopeId2));
                  } else {
                    _push3(ssrRenderComponent(unref(Icon), { icon: AlignRight }, null, _parent3, _scopeId2));
                  }
                } else {
                  return [
                    align.value === "right" ? (openBlock(), createBlock(unref(Icon), {
                      key: 0,
      ...
      _push(`</div><div class="colors" data-v-19d6ac4e><!--[-->`);
      ssrRenderList(colors.value, (color) => {
        _push(ssrRenderComponent(unref(Button), {
          ...
          icon: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_sfc_main$s, { color }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
      ...
      _push(ssrRenderComponent(unref(Button), {
        ...
        icon: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$s, { color: primaryColor.value }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              createVNode(_sfc_main$s, { color: primaryColor.value }, {
                default: withCtx(() => [
                  activeColor.value === primaryColor.value ? (openBlock(), createBlock(unref(Icon), {
                    key: 0,
                    icon: SquareActive
...
const Settings = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-19d6ac4e"]]);

export { AuthForm as A, Settings as S };
//# sourceMappingURL=Settings-CZ4zCdTy.mjs.map
