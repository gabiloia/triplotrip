import { depx, changeColor, getPreciseEventTarget, happensIn } from 'seemly';
import { createTreeMate, SubtreeNotLoadedError } from 'treemate';
import { useMergedState, useIsMounted, useMemo } from 'vooks';
import { defineComponent, h, ref, computed, isReactive, watch, toRef, nextTick, provide, Transition, withDirectives, inject } from 'vue';
import { clickoutside } from 'vdirs';
import { ar as Binder, as as VTarget, at as VFollower, au as useAdjustedTo, u as useConfig, s as useTheme, bz as cascaderLight, l as c$1, T as useLocale, J as useFormItem, g as createInjectionKey, x as useThemeClass, I as resolveSlot, bb as NEmpty, q as resolveWrappedSlot, aE as FocusDetector, aR as useOnResize, av as NInternalSelectMenu, ay as createTmOptions, j as cB, $ as fadeInScaleUpTransition, m as cE, k as cM, aB as markEventEffectPerformed, S as Scrollbar$1, aC as VVirtualList, X as useStyle, z as call, Y as NBaseLoading, h as NBaseIcon, b6 as ChevronRightIcon, by as FinishedIcon, Z as fadeInTransition } from './server.mjs';
...
const style = c$1([cB("cascader-menu", `
 outline: none;
 position: relative;
 margin: 4px 0;
 display: flex;
...
const NCascader = defineComponent({
  name: "Cascader",
  props: cascaderProps,
  slots: Object,
  setup(props, {
...
export { NCascader as N };
//# sourceMappingURL=Cascader-C_tva_at.mjs.map
