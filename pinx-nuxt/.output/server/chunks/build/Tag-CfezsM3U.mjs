...
import { a_ as useMessage, a as _sfc_main$s, aN as NTag } from './server.mjs';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(NTag), { type: "success" }, {
                    icon: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_sfc_main$s, { name: CheckmarkCircle }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(_sfc_main$s, { name: CheckmarkCircle })
                        ];
                      }
                    }),
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
...
//# sourceMappingURL=Tag-CfezsM3U.mjs.map
