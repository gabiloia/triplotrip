...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-ba3e3944><div class="page-header" data-v-ba3e3944><div class="title" data-v-ba3e3944>Reservas</div></div><div class="components-list" data-v-ba3e3944>`);
...
const Reservas = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ba3e3944"]]);

export { Reservas as default };
//# sourceMappingURL=Reservas-CN-uUvXz.mjs.map
