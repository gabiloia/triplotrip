...
import { a as _export_sfc, N as NCard, al as Scrollbar, _ as _sfc_main$s } from './server.mjs';
import { L as LtrContext } from './LtrContext-DmPOw2ck.mjs';
...
import { N as NCollapse, a as NCollapseItem } from './CollapseItem-CEz2WGwr.mjs';
            ...
            if (_push2) {
              _push2(ssrRenderComponent(unref(NCollapse), null, {
                "header-extra": withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_sfc_main$s, { name: CodeIcon }, null, _parent3, _scopeId2));
                  } else {
                    return [
                      createVNode(_sfc_main$s, { name: CodeIcon })
                    ];
                  }
                }),
...
//# sourceMappingURL=CardCodeExample-Mznr1J6X.mjs.map
