...
import { _ as _sfc_main$s, B as Button, aW as NText } from './server.mjs';
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(Button), { round: "" }, {
                          icon: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_sfc_main$s, { name: LogInIcon }, null, _parent5, _scopeId4));
                            } else {
                              return [
                                createVNode(_sfc_main$s, { name: LogInIcon })
                              ];
                            }
                          }),
...
//# sourceMappingURL=Button-B7ZPzepJ.mjs.map
