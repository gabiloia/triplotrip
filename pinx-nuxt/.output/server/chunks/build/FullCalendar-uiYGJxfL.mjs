...
import { a as _export_sfc, ab as useThemeStore, ac as NSpin, B as Button, _ as _sfc_main$s } from './server.mjs';
  ...
  setup(__props) {
    ...
    const calendarOptions = {
      ...
      events: (info, successCallback) => {
        if (!info) return;
        const events = fullCalendarStore.fetchEvents();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page page-wrapped page-mobile-full page-without-footer flex flex-col" }, _attrs))} data-v-4923e152>`);
      _push(ssrRenderComponent(SegmentedPage, {
        ...
        "sidebar-content": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="section section-calendar" data-v-4923e152${_scopeId}>`);
            ...
            _push2(`</div><div class="section fullcalendar-actions-box" data-v-4923e152${_scopeId}><p class="mb-3 opacity-50" data-v-4923e152${_scopeId}>Calendarios</p><div class="calendars-list" data-v-4923e152${_scopeId}>`);
        ...
        "main-toolbar": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center gap-2" data-v-4923e152${_scopeId}><div class="w-24" data-v-4923e152${_scopeId}>`);
            ...
            _push2(`</div><div data-v-4923e152${_scopeId}>`);
            ...
            _push2(`</div><div class="${ssrRenderClass([{ compact: compactMode.value }, "current-date grow px-3 text-right"])}" data-v-4923e152${_scopeId}>${ssrInterpolate(currentDate.value)}</div>`);
            if (!compactMode.value) {
              _push2(`<div data-v-4923e152${_scopeId}>`);
        ...
        "main-content": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="main scrollbar-styled h-full" data-v-4923e152${_scopeId}>`);
            if (ready.value) {
...
const FullCalendar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4923e152"]]);

export { FullCalendar as default };
//# sourceMappingURL=FullCalendar-uiYGJxfL.mjs.map
