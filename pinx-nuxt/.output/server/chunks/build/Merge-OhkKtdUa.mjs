...
import { defineComponent, resolveComponent, mergeProps, withCtx, createVNode, createTextVNode, h, useSSRContext } from 'vue';
import { ssrRenderComponent } from 'vue/server-renderer';
import { a as _export_sfc, aW as NText, a_ as useMessage, aN as NTag, B as Button } from './server.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Tables/data-tables-components/Merge.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Merge = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { Merge as default };
//# sourceMappingURL=Merge-OhkKtdUa.mjs.map
