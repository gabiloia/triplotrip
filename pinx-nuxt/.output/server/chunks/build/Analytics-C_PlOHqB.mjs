...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-8fad8fb8><div class="main-grid gap-5" data-v-8fad8fb8><div class="main-col" data-v-8fad8fb8><div class="flex h-full flex-col gap-5" data-v-8fad8fb8><div class="main-chart-wrap flex" data-v-8fad8fb8>`);
      _push(ssrRenderComponent(_component_CardCombo3, { class: "h-full" }, null, _parent));
      _push(`</div><div class="flex grow" data-v-8fad8fb8>`);
      ...
      _push(`</div></div></div><div class="side-col" data-v-8fad8fb8><div class="flex h-full flex-col gap-5" data-v-8fad8fb8><div class="flex" data-v-8fad8fb8>`);
      ...
      _push(`</div><div class="timeline-wrap grow" data-v-8fad8fb8>`);
...
const Analytics = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8fad8fb8"]]);

export { Analytics as default };
//# sourceMappingURL=Analytics-C_PlOHqB.mjs.map
