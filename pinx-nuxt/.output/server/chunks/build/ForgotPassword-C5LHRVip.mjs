...
import { S as Settings, A as AuthForm } from './Settings-CQNKcp2-.mjs';
import { a as _export_sfc, aY as useAuthStore } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--6429a8ff": activeColor.value
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-auth" }, _attrs, _cssVars))} data-v-5f49f9cb>`);
      if (!isLogged.value) {
      ...
      if (!isLogged.value) {
        _push(`<div class="wrapper flex justify-center" data-v-5f49f9cb>`);
        if (align.value === "right") {
          _push(`<div class="image-box basis-2/3" data-v-5f49f9cb></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="${ssrRenderClass([{ centered: align.value === "center" }, "form-box flex basis-1/3 items-center justify-center"])}" data-v-5f49f9cb>`);
...
const ForgotPassword = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5f49f9cb"]]);

export { ForgotPassword as default };
//# sourceMappingURL=ForgotPassword-C5LHRVip.mjs.map
