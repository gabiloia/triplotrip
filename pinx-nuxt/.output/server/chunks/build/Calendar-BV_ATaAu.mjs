...
import { a_ as useMessage, _ as _sfc_main$s, R as resolveSlotWithTypedProps, B as Button, h as NBaseIcon, b6 as ChevronRightIcon, u as useConfig, s as useTheme, bP as calendarLight, l as c$1, T as useLocale, x as useThemeClass, j as cB, ao as insideModal, ap as insidePopover, m as cE, k as cM, z as call } from './server.mjs';
import { useMergedState } from 'vooks';
import { k as getYear, j as getMonth, b as startOfMonth, d as dateArray, a as addMonths } from './utils-gRb4MLhP.mjs';
import { e as startOfDay, f as format } from './getDefaultOptions-Badlq585.mjs';
import { N as NButtonGroup } from './ButtonGroup-BgUV4cXl.mjs';
import { C as ChevronLeftIcon } from './CollapseItem-CEz2WGwr.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function handleUpdateValue(_, { month, date, year }) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(NCalendar), { "onUpdate:value": handleUpdateValue }, {
              default: withCtx(({ month, date, year }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(month)}-${ssrInterpolate(date)}-${ssrInterpolate(year)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(month) + "-" + toDisplayString(date) + "-" + toDisplayString(year), 1)
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode(unref(NCalendar), { "onUpdate:value": handleUpdateValue }, {
                default: withCtx(({ month, date, year }) => [
                  createTextVNode(toDisplayString(month) + "-" + toDisplayString(date) + "-" + toDisplayString(year), 1)
                ]),
                _: 1
              })
...
//# sourceMappingURL=Calendar-BV_ATaAu.mjs.map
