                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(NAlert), {
                    ...
                    icon: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_sfc_main$o, { name: Airplane }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(_sfc_main$o, { name: Airplane })
                        ];
                      }
                    }),
...
//# sourceMappingURL=Alert-DEKTgEak.mjs.map
