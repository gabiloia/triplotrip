                    ...
                    _push3(ssrRenderComponent(unref(NForm), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        ...
                        if (_push4) {
                          ...
                          _push4(`<div class="flex flex-col justify-between sm:flex-row" data-v-6d0a7bb4${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(NFormItem), {
                            label: "Start",
                            path: "start"
                          }, {
                          ...
                          _push4(`<div class="flex items-center justify-end gap-3" data-v-6d0a7bb4${_scopeId3}>`);
...
const EventEditor = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6d0a7bb4"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useHideLayoutFooter();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page page-wrapped page-mobile-full page-without-footer flex flex-col" }, _attrs))} data-v-e14b9cbb>`);
      _push(ssrRenderComponent(SegmentedPage, {
        ...
        "sidebar-content": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="section section-calendar" data-v-e14b9cbb${_scopeId}>`);
            ...
            _push2(`</div><div class="section fullcalendar-actions-box" data-v-e14b9cbb${_scopeId}><p class="mb-3 opacity-50" data-v-e14b9cbb${_scopeId}>Calendars</p><div class="calendars-list" data-v-e14b9cbb${_scopeId}>`);
        ...
        "main-toolbar": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center gap-2" data-v-e14b9cbb${_scopeId}><div class="w-24" data-v-e14b9cbb${_scopeId}>`);
            ...
            _push2(`</div><div data-v-e14b9cbb${_scopeId}>`);
            ...
            _push2(`</div><div class="${ssrRenderClass([{ compact: compactMode.value }, "current-date grow px-3 text-right"])}" data-v-e14b9cbb${_scopeId}>${ssrInterpolate(currentDate.value)}</div>`);
            if (!compactMode.value) {
              _push2(`<div data-v-e14b9cbb${_scopeId}>`);
        ...
        "main-content": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="main scrollbar-styled h-full" data-v-e14b9cbb${_scopeId}>`);
            if (ready.value) {
...
const FullCalendar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e14b9cbb"]]);

export { FullCalendar as default };
//# sourceMappingURL=FullCalendar-Bds1a40g.mjs.map
