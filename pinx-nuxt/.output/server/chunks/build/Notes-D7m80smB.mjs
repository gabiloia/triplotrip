...
import { a as _export_sfc, aa as useThemeStore, B as Button, _ as _sfc_main$o, b as NModal, N as NCard, c as NText } from './server.mjs';
import { faker } from '@faker-js/faker';
import dayjs from 'dayjs';
import _clone from 'lodash/cloneDeep.js';
import { N as NSelect } from './Select-CARuIkFC.mjs';
import { N as NImageGroup, a as NImage } from './Image-BM4Ny04G.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Button), {
        ...
        icon: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$o, { name: AddIcon }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$o, { name: AddIcon })
            ];
          }
        }),
...
//# sourceMappingURL=Notes-D7m80smB.mjs.map
