  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _cssVars = { style: {
        "--58bb79ac": activeColor.value
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-auth" }, _attrs, _cssVars))} data-v-de219776>`);
      if (!isLogged.value) {
      ...
      if (!isLogged.value) {
        _push(`<div class="wrapper flex justify-center" data-v-de219776>`);
        if (align.value === "right") {
          _push(`<div class="image-box basis-2/3" data-v-de219776></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="${ssrRenderClass([{ centered: align.value === "center" }, "form-box flex basis-1/3 items-center justify-center"])}" data-v-de219776>`);
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-de219776"]]);

export { Login as default };
//# sourceMappingURL=Login-BAm5ul-4.mjs.map
