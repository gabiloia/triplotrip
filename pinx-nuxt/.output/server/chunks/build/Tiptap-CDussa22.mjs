...
import { a as _export_sfc, _ as _sfc_main$s, al as Scrollbar } from './server.mjs';
              ...
              createVNode("div", { class: "menu-bar-scroll" }, [
                (openBlock(), createBlock(Fragment, null, renderList(items, (item, index) => {
                  return openBlock(), createBlock(Fragment, null, [
                    ...
                    !item.type ? (openBlock(), createBlock(_sfc_main$3, mergeProps({
                      key: index,
                      ref_for: true
                    }, item), null, 16)) : createCommentVNode("", true)
                  ], 64);
                }), 64))
              ])
            ];
...
//# sourceMappingURL=Tiptap-CDussa22.mjs.map
