...
import { a as _export_sfc, aa as useThemeStore, ab as renderIcon, B as Button, _ as _sfc_main$o, aY as NMenu, d as NAvatar, ac as NDropdown, e as NTooltip } from './server.mjs';
import { onClickOutside } from '@vueuse/core';
import { N as NCheckbox } from './Checkbox-PH_UPMG8.mjs';
import { N as NInput } from './Input-jKcDFmK2.mjs';
import { N as NInputGroup } from './InputGroup-Dx9Xcrko.mjs';
import { N as NAutoComplete } from './AutoComplete-DcX2Mhy7.mjs';
import { N as NButtonGroup } from './ButtonGroup-Bxqgi_vt.mjs';
import { N as NForm, a as NFormItem } from './FormItem-GCUOpT98.mjs';
import { faker } from '@faker-js/faker';
import dayjs from 'dayjs';
import { defineStore } from 'pinia';
import { N as NTime } from './Time-BSjy98vF.mjs';
import { S as SegmentedPage } from './SegmentedPage-CGYmcYi9.mjs';
import { u as useHideLayoutFooter } from './useHideLayoutFooter-aa8p3ouE.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
...
import './index-2dG9pLRO.mjs';
import './getDefaultOptions-7aEwQRJB.mjs';
      ...
      if (!_ctx.checkControl) {
        ...
        _push(ssrRenderComponent(unref(NInput), {
          ...
          prefix: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_sfc_main$o, { name: SearchIcon }, null, _parent2, _scopeId));
            } else {
              return [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Button), { ghost: "" }, {
        icon: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$o, { name: DocumentAddIcon }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$o, { name: DocumentAddIcon })
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(Button), {
              ...
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$o, { name: SentIcon$1 }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_sfc_main$o, { name: SentIcon$1 })
                  ];
                }
              }),
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Button), {
                    ...
                    icon: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_sfc_main$o, { name: ChevronDownIcon }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(_sfc_main$o, { name: ChevronDownIcon })
                        ];
                      }
                    }),
                    _: 1
      ...
      _push(ssrRenderComponent(unref(Button), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              _ctx.email.starred ? (openBlock(), createBlock(_sfc_main$o, {
                key: 0,
                size: 16,
                name: StarActiveIcon$1,
                class: "text-primary"
                ...
                if (_push3) {
                  ...
                  return [
                    _ctx.email.starred ? (openBlock(), createBlock(_sfc_main$o, {
                      ...
                      name: StarActiveIcon,
                      color: primaryColor.value
                    }, null, 8, ["color"])) : (openBlock(), createBlock(_sfc_main$o, {
                      key: 1,
                      size: 20,
                      name: StarIcon
                    }))
...
//# sourceMappingURL=Mailbox-RVBKwWHk.mjs.map
