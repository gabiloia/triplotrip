...
import { _ as _sfc_main$o, c as NText, ag as NDropdown } from './server.mjs';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(NBreadcrumbItem), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_sfc_main$o, { name: Cash }, null, _parent4, _scopeId3));
                        _push4(` Home `);
                      } else {
                        return [
                          createVNode(_sfc_main$o, { name: Cash }),
...
//# sourceMappingURL=Breadcrumb-DCJB-wvT.mjs.map
