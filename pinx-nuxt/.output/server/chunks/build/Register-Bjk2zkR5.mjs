...
import { A as AuthForm } from './AuthForm-BYOg7r_S.mjs';
import { a as _export_sfc, aA as useAuthStore } from './server.mjs';
import { useRoute } from 'vue-router';
import './FormItem-BD_bmr5c.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _cssVars = { style: {
        "--4d677c60": activeColor.value
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-auth" }, _attrs, _cssVars))} data-v-d32e2d14>`);
      if (!isLogged.value) {
      ...
      if (!isLogged.value) {
        _push(`<div class="wrapper flex justify-center" data-v-d32e2d14>`);
        if (align.value === "right") {
          _push(`<div class="image-box basis-2/3" data-v-d32e2d14></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="${ssrRenderClass([{ centered: align.value === "center" }, "form-box flex basis-1/3 items-center justify-center"])}" data-v-d32e2d14>`);
...
const Register = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d32e2d14"]]);

export { Register as default };
//# sourceMappingURL=Register-Bjk2zkR5.mjs.map
