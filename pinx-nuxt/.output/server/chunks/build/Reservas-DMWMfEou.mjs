...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-088fb827><div class="page-header" data-v-088fb827><div class="title" data-v-088fb827>Reservas</div></div><div class="components-list" data-v-088fb827>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Reservas.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Reservas = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-088fb827"]]);

export { Reservas as default };
//# sourceMappingURL=Reservas-DMWMfEou.mjs.map
