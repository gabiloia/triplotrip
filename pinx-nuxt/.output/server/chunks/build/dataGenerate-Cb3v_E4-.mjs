...
function generateFakeDataDemo(rows, colsNumber, pinColumn) {
  const defColumns = [
    {
      name: "Name",
      prop: "name",
      ...
      children: [
        {
          ...
          name: "Age",
          prop: "age",
          pin: pinColumn ? "colPinEnd" : void 0
        },
        {
          sortable: true,
          name: "Company",
  ...
  for (const i in result) {
    ...
    for (let j = 0; j < colsNumber; j++) {
      result[i][j] = getRandomArbitrary(0, 1e4);
    }
  }
  return {
    source: result,
...
export { generateFakeDataObject as default, generateFakeDataDemo };
//# sourceMappingURL=dataGenerate-Cb3v_E4-.mjs.map
