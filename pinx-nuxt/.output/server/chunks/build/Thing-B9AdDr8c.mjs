...
import { a as _sfc_main$s, a$ as NDivider, c as NAvatar, B as Button } from './server.mjs';
import { N as NRow, a as NCol } from './Col-CyPtjl9C.mjs';
import { N as NCheckbox } from './Checkbox-kHPptutx.mjs';
import { N as NThing } from './Thing-DgS-cRUE.mjs';
                ...
                fn: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(unref(NAvatar), { "img-props": { alt: "avatar" } }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_sfc_main$s, { name: CashIcon }, null, _parent4, _scopeId3));
                        } else {
                          return [
                            createVNode(_sfc_main$s, { name: CashIcon })
                          ];
                        }
                      }),
                      _: 1
                        ...
                        if (_push4) {
                          _push4(ssrRenderComponent(unref(Button), { size: "small" }, {
                            icon: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_sfc_main$s, { name: CashIcon }, null, _parent5, _scopeId4));
                              } else {
                                return [
                                  createVNode(_sfc_main$s, { name: CashIcon })
                                ];
...
//# sourceMappingURL=Thing-B9AdDr8c.mjs.map
