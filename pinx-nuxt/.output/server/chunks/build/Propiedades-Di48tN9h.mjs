...
import { a as _export_sfc, N as NCard, B as Button, _ as _sfc_main$s, b as NModal } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-7a16b404><h1 data-v-7a16b404>Propiedades</h1><div class="masonry" data-v-7a16b404><!--[-->`);
      ssrRenderList(propiedades.value, (prop) => {
        _push(`<div class="card-wrap" data-v-7a16b404>`);
        _push(ssrRenderComponent(unref(NCard), { hoverable: "" }, {
          cover: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (getImagenUrl(prop)) {
                _push2(`<img${ssrRenderAttr("src", getImagenUrl(prop))} alt="Foto principal" width="900" height="400" data-v-7a16b404${_scopeId}>`);
              } else {
                _push2(`<!---->`);
              }
            } else {
          ...
          header: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span data-v-7a16b404${_scopeId}>${ssrInterpolate(prop.Titulo || "Cargando t\xEDtulo...")}</span>`);
            } else {
              return [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<p data-v-7a16b404${_scopeId}>${ssrInterpolate(prop.Descripcion || "Cargando descripcion...")}</p>`);
            } else {
              return [
          ...
          action: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex items-center justify-between" data-v-7a16b404${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Button), {
                type: "primary",
...
const Propiedades = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7a16b404"]]);

export { Propiedades as default };
//# sourceMappingURL=Propiedades-Di48tN9h.mjs.map
