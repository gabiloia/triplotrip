...
import { _ as _export_sfc, ab as useThemeStore, aU as renderIcon, B as Button, a as _sfc_main$s, c as NAvatar, aV as NDropdown } from './server.mjs';
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(NInput), {
              ...
              prefix: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$s, { name: SearchIcon }, null, _parent3, _scopeId2));
                } else {
                  return [
...
//# sourceMappingURL=Chat-C2m8S7Mr.mjs.map
