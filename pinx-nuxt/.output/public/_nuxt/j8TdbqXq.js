import{_ as C}from"./CecrDnS1.js";import{d as k,af as y,c as I,o as b,a as r,e as t,b as n,_ as p,w as o,u as s,ag as l,t as c}from"./CghEsQSB.js";import{N as u}from"./B-kWjqJT.js";import"./DBs0U9JY.js";import"./9xxGHCVY.js";import"./Bk_rJcZu.js";const w={class:"page"},Y={class:"page-header"},v={class:"links"},h={href:"https://www.naiveui.com/en-US/light/components/tag",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},T={class:"components-list"},x="tabler:external-link",f="ion:checkmark-circle",M=k({__name:"Tag",setup(L){const m=y();function a(){m.info("tag close")}function _(){m.info("tag click")}return(N,e)=>{const d=C;return b(),I("div",w,[r("div",Y,[e[1]||(e[1]=r("div",{class:"title"},"Tag",-1)),r("div",v,[r("a",h,[t(p,{name:x,size:16}),e[0]||(e[0]=n(" docs "))])])]),r("div",T,[t(d,{title:"Type"},{code:o(({html:i})=>[n(c(i(`
					<n-space>
