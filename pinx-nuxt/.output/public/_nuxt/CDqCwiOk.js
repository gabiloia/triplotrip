import{_ as U}from"./BfzzecIy.js";import{ay as p,aw as e,c3 as W,c4 as q,aA as Q,ax as A,az as F,d as L,aB as X,a7 as s,dg as Y,aE as Z,aF as J,s as G,aL as M,aN as ee,aG as te,eJ as oe,c as re,a as ne,b as y,g as m,f as b,h as se,w as g,u as x,t as le}from"./CFnCIwgc.js";import{g as ie}from"./Bk_rJcZu.js";import"./uLUuACJr.js";import"./Bg-0ZsXF.js";function H(n,h="default",t=[]){const{children:i}=n;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[h];if(typeof l=="function")return l()}return t}const ae=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
 ...
 `))]),K="DESCRIPTION_ITEM_FLAG";function de(n){return typeof n=="object"&&n&&!Array.isArray(n)?n.type&&n.type[K]:!1}const ce=Object.assign(Object.assign({},J.props),{title:String,column:{type:Number,default:3},columns:Number,labelPlacement:{type:String,default:"top"},labelAlign:{type:String,default:"left"},separator:{type:String,default:":"},size:{type:String,default:"medium"},bordered:Boolean,labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]}),pe=L({name:"Descriptions",props:ce,slots:Object,setup(n){const{mergedClsPrefixRef:h,inlineThemeDisabled:t}=Z(n),i=J("Descriptions","-descriptions",ae,oe,n,h),l=G(()=>{const{size:d,bordered:u}=n,{common:{cubicBezierEaseInOut:f},self:{titleTextColor:k,thColor:D,thColorModal:r,thColorPopover:B,thTextColor:S,thFontWeight:R,tdTextColor:I,tdColor:N,tdColorModal:T,tdColorPopover:o,borderColor:C,borderColorModal:O,borderColorPopover:c,borderRadius:v,lineHeight:z,[M("fontSize",d)]:_,[M(u?"thPaddingBordered":"thPadding",d)]:w,[M(u?"tdPaddingBordered":"tdPadding",d)]:$}}=i.value;return{"--n-title-text-color":k,"--n-th-padding":w,"--n-td-padding":$,"--n-font-size":_,"--n-bezier":f,"--n-th-font-weight":R,"--n-line-height":z,"--n-th-text-color":S,"--n-td-text-color":I,"--n-th-color":D,"--n-th-color-modal":r,"--n-th-color-popover":B,"--n-td-color":N,"--n-td-color-modal":T,"--n-td-color-popover":o,"--n-border-radius":v,"--n-border-color":C,"--n-border-color-modal":O,"--n-border-color-popover":c}}),a=t?ee("descriptions",G(()=>{let d="";const{size:u,bordered:f}=n;return f&&(d+="a"),d+=u[0],d}),l,n):void 0;return{mergedClsPrefix:h,cssVars:t?void 0:l,themeClass:a==null?void 0:a.themeClass,onRender:a==null?void 0:a.onRender,compitableColumn:te(n,["columns","column"]),inlineThemeDisabled:t}},render(){const n=this.$slots.default,h=n?X(n()):[];h.length;const{contentClass:t,labelClass:i,compitableColumn:l,labelPlacement:a,labelAlign:d,size:u,bordered:f,title:k,cssVars:D,mergedClsPrefix:r,separator:B,onRender:S}=this;S==null||S();const R=h.filter(o=>de(o)),I={span:0,row:[],secondRow:[],rows:[]},T=R.reduce((o,C,O)=>{const c=C.props||{},v=R.length-1===O,z=["label"in c?c.label:H(C,"label")],_=[H(C)],w=c.span||1,$=o.span;o.span+=w;const j=c.labelStyle||c["label-style"]||this.labelStyle,E=c.contentStyle||c["content-style"]||this.contentStyle;if(a==="left")f?o.row.push(s("th",{class:[`${r}-descriptions-table-header`,i],colspan:1,style:j},z),s("td",{class:[`${r}-descriptions-table-content`,t],colspan:v?(l-$)*2+1:w*2-1,style:E},_)):o.row.push(s("td",{class:`${r}-descriptions-table-content`,colspan:v?(l-$)*2:w*2},s("span",{class:[`${r}-descriptions-table-content__label`,i],style:j},[...z,B&&s("span",{class:`${r}-descriptions-separator`},B)]),s("span",{class:[`${r}-descriptions-table-content__content`,t],style:E},_)));else{const V=v?(l-$)*2:w*2;o.row.push(s("th",{class:[`${r}-descriptions-table-header`,i],colspan:V,style:j},z)),o.secondRow.push(s("td",{class:[`${r}-descriptions-table-content`,t],colspan:V,style:E},_))}return(o.span>=l||v)&&(o.span=0,o.row.length&&(o.rows.push(o.row),o.row=[]),a!=="left"&&o.secondRow.length&&(o.rows.push(o.secondRow),o.secondRow=[])),o},I).rows.map(o=>s("tr",{class:`${r}-descriptions-table-row`},o));return s("div",{style:D,class:[`${r}-descriptions`,this.themeClass,`${r}-descriptions--${a}-label-placement`,`${r}-descriptions--${d}-label-align`,`${r}-descriptions--${u}-size`,f&&`${r}-descriptions--bordered`]},k||this.$slots.header?s("div",{class:`${r}-descriptions-header`},k||ie(this,"header")):null,s("div",{class:`${r}-descriptions-table-wrapper`},s("table",{class:`${r}-descriptions-table`},s("tbody",null,a==="top"&&s("tr",{class:`${r}-descriptions-table-row`,style:{visibility:"collapse"}},Y(l*2,s("td",null))),T))))}}),be={label:String,span:{type:Number,default:1},labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]},P=L({name:"DescriptionsItem",[K]:!0,props:be,slots:Object,render(){return null}}),ge={class:"page"},he={class:"page-header"},me={class:"links"},ue={href:"https://www.naiveui.com/en-US/light/components/descriptions",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},fe={class:"components-list"},ve="tabler:external-link",ze=L({__name:"Descriptions",setup(n){return(h,t)=>{const i=U;return ne(),re("div",ge,[y("div",he,[t[1]||(t[1]=y("div",{class:"title"},"Descriptions",-1)),y("div",me,[y("a",ue,[m(se,{name:ve,size:16}),t[0]||(t[0]=b(" docs "))])])]),y("div",fe,[m(i,{title:"Basic"},{code:g(({html:l})=>[b(le(l(`
					...
					`)),1)]),default:g(()=>[m(x(pe),{"label-placement":"top",title:"Description"},{default:g(()=>[m(x(P),null,{label:g(()=>t[2]||(t[2]=[b("Breakfast")])),default:g(()=>[t[3]||(t[3]=b(" Apple "))]),_:1}),m(x(P),{label:"Brunch"},{default:g(()=>t[4]||(t[4]=[b("Apple")])),_:1}),m(x(P),{label:"Lunch"},{default:g(()=>t[5]||(t[5]=[b("Apple")])),_:1}),m(x(P),{label:"Supper",span:2},{default:g(()=>t[6]||(t[6]=[b(" Two "),y("br",null,null,-1),b(" Apples ")])),_:1}),m(x(P),{label:"Midnight Snack"},{default:g(()=>t[7]||(t[7]=[b("Apple")])),_:1})]),_:1})]),_:1})])])}}});export{ze as default};
