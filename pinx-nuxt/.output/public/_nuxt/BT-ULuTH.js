import{_ as v}from"./0RhdNeLw.js";import{d as u,c as f,o as x,a as n,e as l,b as i,_ as p,w as t,u as o,t as r,O as c}from"./CKyhG2UO.js";import{N as m,a}from"./BLIjkjma.js";import"./BMJuwibk.js";const w={class:"page"},y={class:"page-header"},C={class:"links"},_={href:"https://www.naiveui.com/en-US/light/components/collapse",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},N={class:"components-list"},g="ion:cash-outline",h="tabler:external-link",I=u({__name:"Collapse",setup(B){return(k,e)=>{const s=v;return x(),f("div",w,[n("div",y,[e[1]||(e[1]=n("div",{class:"title"},"Collapse",-1)),n("div",C,[n("a",_,[l(p,{name:h,size:16}),e[0]||(e[0]=i(" docs "))])])]),n("div",N,[l(s,{title:"Basic"},{code:t(({html:d})=>[i(r(d(`
					<n-collapse>
