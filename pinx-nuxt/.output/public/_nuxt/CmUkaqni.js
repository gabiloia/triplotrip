import{_ as E}from"./CecrDnS1.js";import{d as x,q as m,c as G,o as D,a as s,e as o,b as n,_ as A,w as t,u as a,B as r,dX as w,dY as y,t as f,z as v}from"./CghEsQSB.js";import{N as k}from"./B00SQpVQ.js";import"./DBs0U9JY.js";import"./9xxGHCVY.js";const W={class:"page"},C={class:"page-header"},L={class:"links"},_={href:"https://www.naiveui.com/en-US/light/components/drawer",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},H={class:"components-list"},I="tabler:external-link",$=x({__name:"Drawer",setup(T){const p=m(!1),c=m(!1),g=m(!1),l=m("right");function h(u){p.value=!0,l.value=u}function d(u){c.value=!0,l.value=u}return(u,e)=>{const S=E;return D(),G("div",W,[s("div",C,[e[13]||(e[13]=s("div",{class:"title"},"Drawer",-1)),s("div",L,[s("a",_,[o(A,{name:I,size:16}),e[12]||(e[12]=n(" docs "))])])]),s("div",H,[o(S,{title:"Basic"},{code:t(({html:i,js:b})=>[n(f(i(`
					<n-button-group>
