...
`,[V("block",`
 ...
 `)])])]),Ae=Object.assign(Object.assign(Object.assign(Object.assign({},J.props),{affix:Boolean}),ge),D),Te=I({name:"Anchor",props:Ae,setup(t,{slots:n}){const{mergedClsPrefixRef:o,inlineThemeDisabled:a}=se(t),e=J("Anchor","-anchor",_e,ue,t,o),f=w(null),h=W(()=>{const{self:{railColor:g,linkColor:x,railColorActive:N,linkTextColor:C,linkTextColorHover:y,linkTextColorPressed:_,linkTextColorActive:d,linkFontSize:c,railWidth:i,linkPadding:r,borderRadius:m},common:{cubicBezierEaseInOut:R}}=e.value;return{"--n-link-border-radius":m,"--n-link-color":x,"--n-link-font-size":c,"--n-link-text-color":C,"--n-link-text-color-hover":y,"--n-link-text-color-active":d,"--n-link-text-color-pressed":_,"--n-link-padding":r,"--n-bezier":R,"--n-rail-color":g,"--n-rail-color-active":N,"--n-rail-width":i}}),s=a?ce("anchor",void 0,h,t):void 0;return{scrollTo(g){var x;(x=f.value)===null||x===void 0||x.setActiveHref(g)},renderAnchor:()=>(s==null||s.onRender(),k(Ce,Object.assign({ref:f,style:a?void 0:h.value,class:s==null?void 0:s.themeClass.value},G(t,Be),{mergedClsPrefix:o.value}),n))}},render(){return this.affix?k(ve,Object.assign({},G(this,pe)),{default:this.renderAnchor}):this.renderAnchor()}}),Ee={class:"page"},Se={class:"page-header"},Pe={class:"links"},$e={href:"https://www.naiveui.com/en-US/light/components/anchor",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},He={class:"components-list"},ze="tabler:external-link",Fe=I({__name:"Anchor",setup(t){const n=w(!0),o=w(!0);return(a,e)=>{const f=X;return de(),fe("div",Ee,[T("div",Se,[e[3]||(e[3]=T("div",{class:"title"},"Anchor",-1)),T("div",Pe,[T("a",$e,[v(he,{name:ze,size:16}),e[2]||(e[2]=z(" docs "))])])]),T("div",He,[v(f,{title:"Basic",class:"max-w-lg"},{code:E(({html:h,js:s})=>[z(K(h(`
