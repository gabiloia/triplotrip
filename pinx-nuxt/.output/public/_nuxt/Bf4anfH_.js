import{_}from"./0RhdNeLw.js";import{d as y,q as k,c as f,o as c,a as s,e as o,b as r,_ as N,w as a,u as n,t as u,F as S,r as w,g as B}from"./CKyhG2UO.js";import{N as b}from"./Dh2Me1dS.js";import{N as g}from"./C9sCQoqx.js";import{N as R}from"./DVVoy6ju.js";import{N as C}from"./DGNg-kxS.js";import"./BMJuwibk.js";import"./BLIjkjma.js";import"./Bk_rJcZu.js";const x={class:"page"},L={class:"page-header"},V={class:"links"},D={href:"https://www.naiveui.com/en-US/light/components/radio",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},H={class:"components-list"},M="tabler:external-link",A=y({__name:"Radio",setup(F){const i=k(null);function v(t){i.value=t.target.value}const m=k(null),h=[{value:"Rock'n'Roll Star",label:"Rock'n'Roll Star"},{value:"Shakermaker",label:"Shakermaker"},{value:"Live Forever",label:"Live Forever"},{value:"Up in the Sky",label:"Up in the Sky"},{value:"...",label:"..."}].map(t=>(t.value=t.value.toLowerCase(),t));return(t,e)=>{const p=_;return c(),f("div",x,[s("div",L,[e[2]||(e[2]=s("div",{class:"title"},"Radio",-1)),s("div",V,[s("a",D,[o(N,{name:M,size:16}),e[1]||(e[1]=r(" docs "))])])]),s("div",H,[o(p,{title:"Basic"},{code:a(({html:l,js:d})=>[r(u(l(`
					...
					`))+" "+u(d(`
						...
						`)),1)]),default:a(()=>[o(n(b),null,{default:a(()=>[o(n(g),{checked:i.value==="Definitely Maybe",value:"Definitely Maybe",name:"basic-demo",onChange:v},{default:a(()=>e[3]||(e[3]=[r(" Definitely Maybe ")])),_:1},8,["checked"]),o(n(g),{checked:i.value==="Be Here Now",value:"Be Here Now",name:"basic-demo",onChange:v},{default:a(()=>e[4]||(e[4]=[r(" Be Here Now ")])),_:1},8,["checked"])]),_:1})]),_:1}),o(p,{title:"Button group"},{description:a(()=>e[5]||(e[5]=[r("Sometimes a radio button group can look more elegant.")])),code:a(({html:l,js:d})=>[r(u(l(`
					<n-space vertical>
