import{_ as E}from"./BLzEf9tb.js";import{d as x,o as G,c as D,a as s,e as o,_ as A,b as n,w as t,u as a,B as r,dX as w,dY as y,t as m,z as v,s as f}from"./BboPWEKj.js";import{N as k}from"./CncItRYq.js";import"./BmSAZQUJ.js";import"./BoIEE7Tp.js";const W={class:"page"},C={class:"page-header"},L={class:"links"},H={href:"https://www.naiveui.com/en-US/light/components/drawer",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},I={class:"components-list"},T="tabler:external-link",q=x({__name:"Drawer",setup(B){const p=f(!1),c=f(!1),g=f(!1),l=f("right");function h(u){p.value=!0,l.value=u}function d(u){c.value=!0,l.value=u}return(u,e)=>{const S=E;return G(),D("div",W,[s("div",C,[e[13]||(e[13]=s("div",{class:"title"},"Drawer",-1)),s("div",L,[s("a",H,[o(A,{name:T,size:16}),e[12]||(e[12]=n(" docs ",-1))])])]),s("div",I,[o(S,{title:"Basic"},{code:t(({html:i,js:b})=>[n(m(i(`
					<n-button-group>
					...
					`))+" "+m(b(`
						...
						`)),1)]),default:t(()=>[o(a(k),null,{default:t(()=>[o(a(r),{onClick:e[7]||(e[7]=i=>d("top"))},{default:t(()=>[...e[28]||(e[28]=[n("Top",-1)])]),_:1}),o(a(r),{onClick:e[8]||(e[8]=i=>d("right"))},{default:t(()=>[...e[29]||(e[29]=[n("Right",-1)])]),_:1}),o(a(r),{onClick:e[9]||(e[9]=i=>d("bottom"))},{default:t(()=>[...e[30]||(e[30]=[n("Bottom",-1)])]),_:1}),o(a(r),{onClick:e[10]||(e[10]=i=>d("left"))},{default:t(()=>[...e[31]||(e[31]=[n("Left",-1)])]),_:1})]),_:1}),e[33]||(e[33]=s("div",{id:"drawer-target",style:{position:"relative",width:"100%",height:"300px",border:"1px solid rgba(128, 128, 128, 0.2)","margin-top":"10px",display:"flex","align-items":"center","justify-content":"center",overflow:"hidden"}}," Target Area ",-1)),o(a(w),{show:c.value,"onUpdate:show":e[11]||(e[11]=i=>c.value=i),width:200,height:200,placement:l.value,"trap-focus":!1,to:"#drawer-target"},{default:t(()=>[o(a(y),{title:"Stoner"},{default:t(()=>[...e[32]||(e[32]=[n(" Stoner is a 1965 novel by the American writer John Williams. ",-1)])]),_:1})]),_:1},8,["show","placement"])]),_:1})])])}}});export{q as default};
