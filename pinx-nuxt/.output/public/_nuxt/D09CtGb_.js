import{_ as E}from"./0RhdNeLw.js";import{d as x,q as m,c as G,o as D,a as s,e as o,b as n,_ as A,w as t,u as a,B as r,bU as w,bT as y,t as f,O as v}from"./CKyhG2UO.js";import{N as k}from"./C4_bR07G.js";import"./BMJuwibk.js";import"./BLIjkjma.js";const W={class:"page"},C={class:"page-header"},L={class:"links"},H={href:"https://www.naiveui.com/en-US/light/components/drawer",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},I={class:"components-list"},T="tabler:external-link",z=x({__name:"Drawer",setup(B){const p=m(!1),c=m(!1),g=m(!1),l=m("right");function h(u){p.value=!0,l.value=u}function d(u){c.value=!0,l.value=u}return(u,e)=>{const S=E;return D(),G("div",W,[s("div",C,[e[13]||(e[13]=s("div",{class:"title"},"Drawer",-1)),s("div",L,[s("a",H,[o(A,{name:T,size:16}),e[12]||(e[12]=n(" docs "))])])]),s("div",I,[o(S,{title:"Basic"},{code:t(({html:i,js:b})=>[n(f(i(`
					<n-button-group>
