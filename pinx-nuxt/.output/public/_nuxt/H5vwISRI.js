...
`,[K("block",`
 ...
 `)])])]),_e=Object.assign(Object.assign(Object.assign(Object.assign({},J.props),{affix:Boolean}),pe),D),Te=N({name:"Anchor",props:_e,setup(t,{slots:n}){const{mergedClsPrefixRef:o,inlineThemeDisabled:a}=se(t),e=J("Anchor","-anchor",Ae,ue,t,o),f=w(null),h=W(()=>{const{self:{railColor:p,linkColor:x,railColorActive:j,linkTextColor:B,linkTextColorHover:y,linkTextColorPressed:A,linkTextColorActive:d,linkFontSize:c,railWidth:i,linkPadding:r,borderRadius:m},common:{cubicBezierEaseInOut:C}}=e.value;return{"--n-link-border-radius":m,"--n-link-color":x,"--n-link-font-size":c,"--n-link-text-color":B,"--n-link-text-color-hover":y,"--n-link-text-color-active":d,"--n-link-text-color-pressed":A,"--n-link-padding":r,"--n-bezier":C,"--n-rail-color":p,"--n-rail-color-active":j,"--n-rail-width":i}}),s=a?ce("anchor",void 0,h,t):void 0;return{scrollTo(p){var x;(x=f.value)===null||x===void 0||x.setActiveHref(p)},renderAnchor:()=>(s==null||s.onRender(),k(Be,Object.assign({ref:f,style:a?void 0:h.value,class:s==null?void 0:s.themeClass.value},V(t,Re),{mergedClsPrefix:o.value}),n))}},render(){return this.affix?k(ve,Object.assign({},V(this,ge)),{default:this.renderAnchor}):this.renderAnchor()}}),Ee={class:"page"},Se={class:"page-header"},Pe={class:"links"},$e={href:"https://www.naiveui.com/en-US/light/components/anchor",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},ze={class:"components-list"},He="tabler:external-link",Ue=N({__name:"Anchor",setup(t){const n=w(!0),o=w(!0);return(a,e)=>{const f=Q;return de(),fe("div",Ee,[T("div",Se,[e[3]||(e[3]=T("div",{class:"title"},"Anchor",-1)),T("div",Pe,[T("a",$e,[v(he,{name:He,size:16}),e[2]||(e[2]=H(" docs "))])])]),T("div",ze,[v(f,{title:"Basic",class:"max-w-lg"},{code:E(({html:h,js:s})=>[H(F(h(`
					...
					`)),1)]),default:E(()=>[v(g(we),{style:{"margin-bottom":"12px"}},{default:E(()=>[v(g(G),{value:n.value,"onUpdate:value":e[0]||(e[0]=h=>n.value=h)},null,8,["value"]),e[4]||(e[4]=H(" Show Rail ")),v(g(G),{value:o.value,"onUpdate:value":e[1]||(e[1]=h=>o.value=h)},null,8,["value"]),e[5]||(e[5]=H(" Show Background "))]),_:1}),v(g(Te),{"show-rail":n.value,"show-background":o.value},{default:E(()=>[v(g(R),{title:"Demos",href:"#Demos"},{default:E(()=>[v(g(R),{title:"Basic",href:"#basic.vue"}),v(g(R),{title:"Ignore-Gap",href:"#ignore-gap.vue"}),v(g(R),{title:"Affix",href:"#affix.vue"}),v(g(R),{title:"Scroll To",href:"#scrollto.vue"})]),_:1}),v(g(R),{title:"API",href:"#API"})]),_:1},8,["show-rail","show-background"])]),_:1})])])}}});export{Ue as default};
