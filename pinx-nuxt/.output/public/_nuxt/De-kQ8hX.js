import{_ as P}from"./D5u1-tCJ.js";import{d as B,q as r,ah as S,c as U,o as q,a as m,e as l,b as o,_ as C,w as n,u as a,B as w,t as d}from"./BF1SYJr_.js";import{N as M}from"./ClzGatxk.js";import{N as x}from"./poIEkNy_.js";import{N as p}from"./DxHjxoxe.js";import{N as y}from"./DWEhlUin.js";import{N as z}from"./DKjXIae1.js";import{N as i}from"./D5TPiXZd.js";import{N as f}from"./D45D5JR9.js";import"./BXLbaQXh.js";import"./BV4ia66y.js";import"./Bk_rJcZu.js";import"./DcLstKRx.js";import"./C3eAAxnx.js";import"./D-9WsAYk.js";const R={class:"page"},F={class:"page-header"},A={class:"links"},E={href:"https://www.naiveui.com/en-US/light/components/form",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},D={class:"components-list"},T={style:{direction:"ltr"}},J="tabler:external-link",oe=B({__name:"Form",setup(O){const b=r("medium"),g=r(!1),c=r(!0),h=r("left"),s=r({brandValue:null,modelValue:null}),_=r(null),k=S(),u=r({user:{name:"",age:""},phone:""}),I={user:{name:{required:!0,message:"Please input your name",trigger:"blur"},age:{required:!0,message:"Please input your age",trigger:["input","blur"]}},phone:{required:!0,message:"Please input your number",trigger:["input"]}};function L(N){var e;N.preventDefault(),(e=_.value)==null||e.validate(v=>{v?k.error("Invalid"):k.success("Valid")})}return(N,e)=>{const v=P;return q(),U("div",R,[m("div",F,[e[10]||(e[10]=m("div",{class:"title"},"Form",-1)),m("div",A,[m("a",E,[l(C,{name:J,size:16}),e[9]||(e[9]=o(" docs "))])])]),m("div",D,[l(v,{title:"Label placement"},{code:n(({html:t,js:V})=>[o(d(t(`
