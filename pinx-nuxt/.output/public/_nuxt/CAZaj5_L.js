import{_ as E}from"./0RhdNeLw.js";import{d as N,a7 as M,aE as A,aF as P,p as I,aN as R,ef as B,q as x,c as T,o as V,a as y,e as t,b as a,_ as O,w as r,u as n,B as w,t as f,O as p}from"./CKyhG2UO.js";import{k as S}from"./zJocfCVL.js";import{N as v}from"./Dh2Me1dS.js";import{N as l}from"./uIcw47pO.js";import"./BMJuwibk.js";import"./BLIjkjma.js";import"./CxN_Fqlt.js";import"./Bk_rJcZu.js";const $=Object.assign(Object.assign({},P.props),{tag:{type:String,default:"div"}}),j=N({name:"Element",alias:["El"],props:$,setup(c){const{mergedClsPrefixRef:i,inlineThemeDisabled:u}=A(c),m=P("Element","-element",void 0,B,c,i),s=I(()=>{const{common:g}=m.value;return Object.keys(g).reduce((C,e)=>(C[`--${S(e)}`]=g[e],C),{})}),o=u?R("element",void 0,s,c):void 0;return{mergedClsPrefix:i,cssVars:u?void 0:s,themeClass:o==null?void 0:o.themeClass,onRender:o==null?void 0:o.onRender}},render(){var c;const{tag:i,mergedClsPrefix:u,cssVars:m,themeClass:s,onRender:o,$slots:g}=this;return o==null||o(),M(i,{role:"none",class:[`${u}-element`,s],style:m},(c=g.default)===null||c===void 0?void 0:c.call(g))}}),D={class:"page"},H={class:"page-header"},L={class:"links"},U={href:"https://www.naiveui.com/en-US/light/components/progress",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},q={class:"components-list"},z="tabler:external-link",_=N({__name:"Progress",setup(c){const i=x(0);function u(){i.value+=10,i.value>100&&(i.value=0)}function m(){i.value-=10,i.value<0&&(i.value=100)}const s=x(0);function o(){s.value+=10,s.value>100&&(s.value=0)}function g(){s.value-=10,s.value<0&&(s.value=100)}return(C,e)=>{const b=E;return V(),T("div",D,[y("div",H,[e[1]||(e[1]=y("div",{class:"title"},"Progress",-1)),y("div",L,[y("a",U,[t(O,{name:z,size:16}),e[0]||(e[0]=a(" docs "))])])]),y("div",q,[t(b,{title:"Circle"},{description:r(()=>[e[7]||(e[7]=a(" Progress can be a circle. It can be ")),t(n(p),{code:""},{default:r(()=>e[2]||(e[2]=[a("default")])),_:1}),e[8]||(e[8]=a(" , ")),t(n(p),{code:""},{default:r(()=>e[3]||(e[3]=[a("info")])),_:1}),e[9]||(e[9]=a(" , ")),t(n(p),{code:""},{default:r(()=>e[4]||(e[4]=[a("success")])),_:1}),e[10]||(e[10]=a(" , ")),t(n(p),{code:""},{default:r(()=>e[5]||(e[5]=[a("warning")])),_:1}),e[11]||(e[11]=a(" or ")),t(n(p),{code:""},{default:r(()=>e[6]||(e[6]=[a("error")])),_:1}),e[12]||(e[12]=a(" status. "))]),code:r(({html:d,js:k})=>[a(f(d(`
					<n-space vertical>
						<n-space>
