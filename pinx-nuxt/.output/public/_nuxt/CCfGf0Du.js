import{_ as C}from"./CecrDnS1.js";import{d as S,q as g,af as _,c as L,o as O,a as c,e as t,b as o,_ as D,w as n,u as l,L as b,B as k,t as s,z as m,J as E,M as p}from"./CghEsQSB.js";import{N as H}from"./B-kWjqJT.js";import"./DBs0U9JY.js";import"./9xxGHCVY.js";import"./Bk_rJcZu.js";const T={class:"page"},A={class:"page-header"},M={class:"links"},R={href:"https://www.naiveui.com/en-US/light/components/dropdown",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},N={class:"components-list"},v="tabler:external-link",U="ion:person-circle-outline",P="ion:pencil",G="ion:log-out-outline",J="ion:arrow-redo-outline",W=S({__name:"Dropdown",setup(j){const y=g(0),w=g(0),f=g(!1),I=_(),d=g([{label:"Marina Bay Sands",key:"marina bay sands",disabled:!0,icon:p(U)},{label:"Brown's Hotel, London",key:"brown's hotel, london",icon:p(P)},{label:"Cascade",key:"cascade",icon:p(J),children:[{label:"Jordan Baker",key:"jordan baker"},{label:"Tom Buchanan",key:"tom buchanan",disabled:!0},{label:"Others",key:"others2",children:[{label:"Chicken",key:"chicken"},{label:"Beef",key:"beef"}]}]},{label:"Atlantis Bahamas, Nassau",key:"atlantis nahamas, nassau",icon:p(G)},{label:"The Beverly Hills Hotel, Los Angeles",key:"the beverly hills hotel, los angeles",icon:p(v)}]);function u(i){I.info(String(i))}function B(i){i.preventDefault(),f.value=!1,E().then(()=>{f.value=!0,y.value=i.clientX,w.value=i.clientY})}function x(){I.info("clickoutside"),f.value=!1}return(i,e)=>{const h=C;return O(),L("div",T,[c("div",A,[e[1]||(e[1]=c("div",{class:"title"},"Dropdown",-1)),c("div",M,[c("a",R,[t(D,{name:v,size:16}),e[0]||(e[0]=o(" docs "))])])]),c("div",N,[t(h,{title:"Basic"},{description:n(()=>e[2]||(e[2]=[o("A basic dropdown.")])),code:n(({html:a,js:r})=>[o(s(a(`
					...
					`))+" "+s(r(`
						...
						`)),1)]),default:n(()=>[t(l(b),{trigger:"hover",options:d.value,scrollable:!0,onSelect:u},{default:n(()=>[t(l(k),null,{default:n(()=>e[3]||(e[3]=[o("Go For a Trip")])),_:1,__:[3]})]),_:1},8,["options"])]),_:1}),t(h,{title:"Trigger"},{description:n(()=>[e[6]||(e[6]=o(" Different ways to ")),t(l(m),{code:""},{default:n(()=>e[4]||(e[4]=[o("trigger")])),_:1,__:[4]}),e[7]||(e[7]=o(" / ")),t(l(m),{code:""},{default:n(()=>e[5]||(e[5]=[o("show")])),_:1,__:[5]}),e[8]||(e[8]=o(" a dropdown. "))]),code:n(({html:a,js:r})=>[o(s(a(`
					<n-space>
						<n-dropdown trigger="hover" :options @select="handleSelect" :scrollable="true">
					...
					`))+" "+s(r(`
						...
						`)),1)]),default:n(()=>[t(l(H),null,{default:n(()=>[t(l(b),{trigger:"hover",options:d.value,scrollable:!0,onSelect:u},{default:n(()=>[t(l(k),null,{default:n(()=>e[9]||(e[9]=[o("Hover!")])),_:1,__:[9]})]),_:1},8,["options"]),t(l(b),{trigger:"click",options:d.value,scrollable:!0,onSelect:u},{default:n(()=>[t(l(k),null,{default:n(()=>e[10]||(e[10]=[o("Click!")])),_:1,__:[10]})]),_:1},8,["options"])]),_:1})]),_:1}),t(h,{title:"Cascade"},{description:n(()=>e[11]||(e[11]=[o("Dropdown options can be cascaded.")])),code:n(({html:a,js:r})=>[o(s(a(`
					<n-dropdown
						:options
					...
					`))+" "+s(r(`
						...
						`)),1)]),default:n(()=>[c("div",{style:{width:"200px",height:"200px","background-color":"rgba(0, 128, 0, 0.5)"},onContextmenu:B}," Right Click ",32),t(l(b),{placement:"bottom-start",trigger:"manual",scrollable:!0,x:y.value,y:w.value,options:d.value,show:f.value,"on-clickoutside":x,onSelect:u},null,8,["x","y","options","show"])]),_:1})])])}}});export{W as default};
