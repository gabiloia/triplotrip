import{_ as W}from"./DApDG8lU.js";import{aA as p,ay as e,bR as q,bS as J,aC as Q,az as A,aB as F,d as L,aD as X,ab as s,bP as Y,aG as Z,aH as K,p as G,aN as E,aP as ee,aI as te,ex as oe,c as re,o as ne,a as y,e as m,b,_ as se,w as g,u as x,t as le}from"./B3WipU5-.js";import{g as ie}from"./Bk_rJcZu.js";import"./BCb3CANw.js";import"./FhkMmAF6.js";function H(n,h="default",t=[]){const{children:i}=n;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[h];if(typeof l=="function")return l()}return t}const ae=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
 ...
 `))]),U="DESCRIPTION_ITEM_FLAG";function de(n){return typeof n=="object"&&n&&!Array.isArray(n)?n.type&&n.type[U]:!1}const ce=Object.assign(Object.assign({},K.props),{title:String,column:{type:Number,default:3},columns:Number,labelPlacement:{type:String,default:"top"},labelAlign:{type:String,default:"left"},separator:{type:String,default:":"},size:{type:String,default:"medium"},bordered:Boolean,labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]}),pe=L({name:"Descriptions",props:ce,slots:Object,setup(n){const{mergedClsPrefixRef:h,inlineThemeDisabled:t}=Z(n),i=K("Descriptions","-descriptions",ae,oe,n,h),l=G(()=>{const{size:d,bordered:u}=n,{common:{cubicBezierEaseInOut:f},self:{titleTextColor:k,thColor:D,thColorModal:r,thColorPopover:B,thTextColor:S,thFontWeight:R,tdTextColor:I,tdColor:N,tdColorModal:T,tdColorPopover:o,borderColor:C,borderColorModal:O,borderColorPopover:c,borderRadius:v,lineHeight:_,[E("fontSize",d)]:z,[E(u?"thPaddingBordered":"thPadding",d)]:w,[E(u?"tdPaddingBordered":"tdPadding",d)]:$}}=i.value;return{"--n-title-text-color":k,"--n-th-padding":w,"--n-td-padding":$,"--n-font-size":z,"--n-bezier":f,"--n-th-font-weight":R,"--n-line-height":_,"--n-th-text-color":S,"--n-td-text-color":I,"--n-th-color":D,"--n-th-color-modal":r,"--n-th-color-popover":B,"--n-td-color":N,"--n-td-color-modal":T,"--n-td-color-popover":o,"--n-border-radius":v,"--n-border-color":C,"--n-border-color-modal":O,"--n-border-color-popover":c}}),a=t?ee("descriptions",G(()=>{let d="";const{size:u,bordered:f}=n;return f&&(d+="a"),d+=u[0],d}),l,n):void 0;return{mergedClsPrefix:h,cssVars:t?void 0:l,themeClass:a==null?void 0:a.themeClass,onRender:a==null?void 0:a.onRender,compitableColumn:te(n,["columns","column"]),inlineThemeDisabled:t}},render(){const n=this.$slots.default,h=n?X(n()):[];h.length;const{contentClass:t,labelClass:i,compitableColumn:l,labelPlacement:a,labelAlign:d,size:u,bordered:f,title:k,cssVars:D,mergedClsPrefix:r,separator:B,onRender:S}=this;S==null||S();const R=h.filter(o=>de(o)),I={span:0,row:[],secondRow:[],rows:[]},T=R.reduce((o,C,O)=>{const c=C.props||{},v=R.length-1===O,_=["label"in c?c.label:H(C,"label")],z=[H(C)],w=c.span||1,$=o.span;o.span+=w;const j=c.labelStyle||c["label-style"]||this.labelStyle,M=c.contentStyle||c["content-style"]||this.contentStyle;if(a==="left")f?o.row.push(s("th",{class:[`${r}-descriptions-table-header`,i],colspan:1,style:j},_),s("td",{class:[`${r}-descriptions-table-content`,t],colspan:v?(l-$)*2+1:w*2-1,style:M},z)):o.row.push(s("td",{class:`${r}-descriptions-table-content`,colspan:v?(l-$)*2:w*2},s("span",{class:[`${r}-descriptions-table-content__label`,i],style:j},[..._,B&&s("span",{class:`${r}-descriptions-separator`},B)]),s("span",{class:[`${r}-descriptions-table-content__content`,t],style:M},z)));else{const V=v?(l-$)*2:w*2;o.row.push(s("th",{class:[`${r}-descriptions-table-header`,i],colspan:V,style:j},_)),o.secondRow.push(s("td",{class:[`${r}-descriptions-table-content`,t],colspan:V,style:M},z))}return(o.span>=l||v)&&(o.span=0,o.row.length&&(o.rows.push(o.row),o.row=[]),a!=="left"&&o.secondRow.length&&(o.rows.push(o.secondRow),o.secondRow=[])),o},I).rows.map(o=>s("tr",{class:`${r}-descriptions-table-row`},o));return s("div",{style:D,class:[`${r}-descriptions`,this.themeClass,`${r}-descriptions--${a}-label-placement`,`${r}-descriptions--${d}-label-align`,`${r}-descriptions--${u}-size`,f&&`${r}-descriptions--bordered`]},k||this.$slots.header?s("div",{class:`${r}-descriptions-header`},k||ie(this,"header")):null,s("div",{class:`${r}-descriptions-table-wrapper`},s("table",{class:`${r}-descriptions-table`},s("tbody",null,a==="top"&&s("tr",{class:`${r}-descriptions-table-row`,style:{visibility:"collapse"}},Y(l*2,s("td",null))),T))))}}),be={label:String,span:{type:Number,default:1},labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]},P=L({name:"DescriptionsItem",[U]:!0,props:be,slots:Object,render(){return null}}),ge={class:"page"},he={class:"page-header"},me={class:"links"},ue={href:"https://www.naiveui.com/en-US/light/components/descriptions",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},fe={class:"components-list"},ve="tabler:external-link",_e=L({__name:"Descriptions",setup(n){return(h,t)=>{const i=W;return ne(),re("div",ge,[y("div",he,[t[1]||(t[1]=y("div",{class:"title"},"Descriptions",-1)),y("div",me,[y("a",ue,[m(se,{name:ve,size:16}),t[0]||(t[0]=b(" docs "))])])]),y("div",fe,[m(i,{title:"Basic"},{code:g(({html:l})=>[b(le(l(`
