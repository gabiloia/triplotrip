import{_ as w}from"./BfzzecIy.js";import{d as y,ad as b,eM as v,c as I,a as C,b as l,g as e,f as o,h as N,w as n,u as a,B as i,t as f,a7 as m,y as W}from"./CFnCIwgc.js";import{N as A}from"./CTeCxYcV.js";import"./uLUuACJr.js";import"./Bg-0ZsXF.js";import"./Bk_rJcZu.js";const x={class:"page"},_={class:"page-header"},B={class:"links"},S={href:"https://www.naiveui.com/en-US/light/components/notification",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},R={class:"components-list"},z="tabler:external-link",L=y({__name:"Notification",setup(E){const u=b(),d=v();function h(){d.create({title:"Wouldn't it be Nice",description:"From the Beach Boys",content:`Wouldn't it be nice if we were older
...
I cant get no, I cant get no`,meta:"2019-5-27 15:11",action:()=>m(i,{text:!0,type:"primary",onClick:()=>{s=!0,t.destroy()}},{default:()=>"Mark as Read"}),onClose:()=>{if(!s)return u.warning("Please mark as read"),!1}})}function c(s){d[s]({content:"What to say?",meta:"I don't know",duration:2500,keepAliveOnHover:!0})}return(s,t)=>{const p=w;return C(),I("div",x,[l("div",_,[t[5]||(t[5]=l("div",{class:"title"},"Notification",-1)),l("div",B,[l("a",S,[e(N,{name:z,size:16}),t[4]||(t[4]=o(" docs "))])])]),l("div",R,[e(p,{title:"Basic",class:"max-w-2xl"},{code:n(({html:r,js:k})=>[o(f(r(`
					...
					`))+" "+f(k(`
						...
						`)),1)]),default:n(()=>[e(a(A),null,{default:n(()=>[e(a(i),{onClick:h},{default:n(()=>t[6]||(t[6]=[o("Wouldn't it be Nice")])),_:1}),e(a(i),{onClick:g},{default:n(()=>t[7]||(t[7]=[o("Satisfaction")])),_:1}),e(a(i),{onClick:t[0]||(t[0]=r=>c("info"))},{default:n(()=>t[8]||(t[8]=[o("Info")])),_:1}),e(a(i),{onClick:t[1]||(t[1]=r=>c("success"))},{default:n(()=>t[9]||(t[9]=[o("Success")])),_:1}),e(a(i),{onClick:t[2]||(t[2]=r=>c("warning"))},{default:n(()=>t[10]||(t[10]=[o("Warning")])),_:1}),e(a(i),{onClick:t[3]||(t[3]=r=>c("error"))},{default:n(()=>t[11]||(t[11]=[o("Error")])),_:1})]),_:1})]),_:1})])])}}});export{L as default};
