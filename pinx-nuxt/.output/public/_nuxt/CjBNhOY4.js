import{_ as w}from"./BZZgnyk_.js";import{d as y,ah as b,x as v,c as I,o as _,a as l,e,b as o,_ as C,w as n,u as a,B as i,t as f,ab as m,C as N}from"./BySaBgEi.js";import{N as W}from"./BCnwlZwB.js";import"./D25RmOv_.js";import"./m78dC5vD.js";import"./Bk_rJcZu.js";const A={class:"page"},x={class:"page-header"},B={class:"links"},S={href:"https://www.naiveui.com/en-US/light/components/notification",target:"_blank",alt:"docs",rel:"nofollow noopener noreferrer"},R={class:"components-list"},z="tabler:external-link",L=y({__name:"Notification",setup(E){const u=b(),d=v();function h(){d.create({title:"Wouldn't it be Nice",description:"From the Beach Boys",content:`Wouldn't it be nice if we were older
