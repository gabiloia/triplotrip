import{_ as ie}from"./BZZgnyk_.js";import{ap as u,as as N,ao as z,at as R,b1 as M,aL as se,d as T,ab as a,aM as ae,au as O,av as le,aw as D,dN as ce,ax as ue,aB as de,aN as P,b8 as A,b5 as pe,aC as fe,aD as me,p as I,aS as m,az as ve,aY as F,aI as E,dO as he,q as H,c as be,o as ge,a as y,e as t,b as f,_ as C,w as o,u as r,B as k,t as B,f as xe}from"./BySaBgEi.js";import{g as we}from"./Bk_rJcZu.js";import{F as Se}from"./CJ67EB9M.js";import{N as $}from"./BCnwlZwB.js";import{N as W}from"./w9zVyjoG.js";import{N as j}from"./C4nqA4Gc.js";import{N as g}from"./DVVvipFI.js";import"./D25RmOv_.js";import"./m78dC5vD.js";const _e=u("steps",`
 width: 100%;
 display: flex;
`,[u("step",`
 position: relative;
 ...
 color: var(--n-indicator-text-color);
 transition: color .3s var(--n-bezier);
 `,[M()])])]),N("vertical","flex-direction: column;",[se("show-description",[z(">",[u("step","padding-bottom: 8px;")])]),z(">",[u("step","margin-bottom: 16px;",[z("&:last-child","margin-bottom: 0;"),z(">",[u("step-indicator",[z(">",[u("step-splitor",`
 position: absolute;
 bottom: -8px;
 width: 1px;
 margin: 0 !important;
...
umber | null>(1)
						...
						`)),1)]),default:o(()=>[t(r($),{vertical:""},{default:o(()=>[t(r(U),{vertical:"",current:i.value,status:s.value},{default:o(()=>[t(r(h),{title:"I Me Mine",description:"All through the day, I me mine I me mine, I me mine"}),t(r(h),{title:"Let It Be",description:"When I find myself in times of trouble Mother Mary comes to me"}),t(r(h),{title:"Break"}),t(r(h),{title:"Come Together",description:"Here come old flat top He come grooving up slowly"}),t(r(h),{title:"Something",description:"Something in the way she moves Attracts me like no other lover"})]),_:1},8,["current","status"]),t(r($),null,{default:o(()=>[t(r(W),null,{default:o(()=>[t(r(k),{onClick:v},{icon:o(()=>[t(C,{name:V})]),_:1}),t(r(k),{onClick:l},{icon:o(()=>[t(C,{name:L})]),_:1})]),_:1}),t(r(j),{value:s.value,"onUpdate:value":n[1]||(n[1]=p=>s.value=p),size:"medium",name:"vertical"},{default:o(()=>[t(r(g),{value:"error"},{default:o(()=>n[8]||(n[8]=[f("Error")])),_:1,__:[8]}),t(r(g),{value:"process"},{default:o(()=>n[9]||(n[9]=[f("Process")])),_:1,__:[9]}),t(r(g),{value:"wait"},{default:o(()=>n[10]||(n[10]=[f("Wait")])),_:1,__:[10]}),t(r(g),{value:"finish"},{default:o(()=>n[11]||(n[11]=[f("Finish")])),_:1,__:[11]})]),_:1},8,["value"])]),_:1})]),_:1})]),_:1})])])}}}),Oe=xe(Ae,[["__scopeId","data-v-3f0a7ec6"]]);export{Oe as default};
