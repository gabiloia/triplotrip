	...
	<div class="page">
		...
		<div class="components-list">
			<CardCodeExample title="Basic">
				...
				<n-dropdown trigger="hover" :options :scrollable="true" @select="handleSelect">
			...
			<CardCodeExample title="Trigger">
				...
				<n-space>
					...
					<n-dropdown trigger="click" :options :scrollable="true" @select="handleSelect">
			...
			<CardCodeExample title="Cascade">
				...
				<n-dropdown :options placement="bottom-start" trigger="click" :scrollable="true" @select="handleSelect">
